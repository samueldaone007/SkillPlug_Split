            ...
            <>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-400">
                  {user?.verified
                    ? 'Your student ID has already been verified.'
                    : user?.verification_requested
                      ? 'Your verification request is under review.'
                      : user?.verification_doc
                        ? 'Uploading a new ID will resubmit your verification request.'
                        : 'Upload your student ID, then request verification from your dashboard.'}
                </p>
                {user?.verification_reject_reason && (
                  <p className="mt-2 rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-xs text-red-600 dark:border-red-800 dark:bg-red-900/20 dark:text-red-400">
